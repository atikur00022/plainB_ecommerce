                            ...
                            <div>
                                <ul className="nav nav-pills p-3 justify-content-center mb-3" id="pills-tab" role="tablist">
                                    <li className="nav-item" role="presentation">
                                        <button onClick={() => {ProductListByRemarkRequest("new")}}
                                    ...
                                    <li className="nav-item" role="presentation">
                                        <button onClick={() => {ProductListByRemarkRequest("trending")}}
                                    ...
                                    <li className="nav-item" role="presentation">
                                        <button onClick={() => {ProductListByRemarkRequest("popular")}}
                                    ...
                                    <li className="nav-item" role="presentation">
                                        <button onClick={() => {ProductListByRemarkRequest("top")}}
                                    ...
                                    <li className="nav-item" role="presentation">
                                        <button onClick={() => {ProductListByRemarkRequest("special")}}
                                                className="nav-link" id="pills-disabled-tab" data-bs-toggle="pill"
                                                                ...
                                                                return (
                                                                    <div key={i}
                                                                        ...
                                                                        <Link to={`/details/${item['_id']}`} className="card shadow-sm h-100 rounded-3 bg-white">
                                                                            <img alt='image' className="w-100 rounded-top-2" src={item["image"]}/>
