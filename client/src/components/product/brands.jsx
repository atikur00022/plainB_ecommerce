...
import BrandsSkeleton from "../../skeletons/brands-skeleton.jsx";
            ...
            <div className="section">
                <div className="container">
                    <div className="row">
                        ...
                        <span className="bodySmal mb-5 text-center">Explore a World of Choices Across Our Most Popular <br/>Top Brands </span>
                        {
